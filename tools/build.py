...
def check_for_changes(addonspath, module):
    if not os.path.exists(os.path.join(addonspath, "meu_comp_{}.pbo".format(module))):
        return True
    return mod_time(os.path.join(addonspath, module)) > mod_time(os.path.join(addonspath, "meu_comp_{}.pbo".format(module)))
    ...
    for p in os.listdir(addonspath):
        ...
        try:
            subprocess.check_output([
                "makepbo",
                "-NUP",
                "-@=z\\addons\\meu_comp\\{}".format(p),
                p,
                "meu_comp_{}.pbo".format(p)
